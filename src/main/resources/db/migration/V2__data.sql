INSERT INTO users (username, password, enabled, authority, first_name, last_name, department, position, phone, email)
VALUES ('jackobrien', '$2a$10$H.W3HhF8pd2Y/TLfDM.t2uQ0F3yI9el9F8nio6VUijbq.SAg/5Ocq', 1, 'ROLE_ADMIN',
'Jack', 'O’Brien', 'Information Technology', 'Specialist', '+353 1 437 0969', 'jackobrien@amics.ie') ON CONFLICT (id) DO NOTHING;

INSERT INTO users (username, password, enabled, authority, first_name, last_name, department, position, phone, email)
VALUES ('gracecarrol', '$2a$10$H.W3HhF8pd2Y/TLfDM.t2uQ0F3yI9el9F8nio6VUijbq.SAg/5Ocq', 1, 'ROLE_MASTER',
'Grace', 'Carroll', 'Purchasing', 'Specialist', '+353 1 889 7856', 'gracecarrol@amics.ie') ON CONFLICT (id) DO NOTHING;

INSERT INTO users (username, password, enabled, authority, first_name, last_name, department, position, phone, email)
VALUES ('danielcollins', '$2a$10$H.W3HhF8pd2Y/TLfDM.t2uQ0F3yI9el9F8nio6VUijbq.SAg/5Ocq', 1, 'ROLE_USER',
'Daniel', 'Collins', 'Plant Engineering', 'Coordinator', '+353 1 645 0897', 'danielcollins@amics.ie') ON CONFLICT (id) DO NOTHING;

INSERT INTO users (username, password, enabled, authority, first_name, last_name, department, position, phone, email)
VALUES ('conorfarrel', '$2a$10$H.W3HhF8pd2Y/TLfDM.t2uQ0F3yI9el9F8nio6VUijbq.SAg/5Ocq', 1, 'ROLE_USER',
'Conor', 'Farrell', 'Plant Engineering', 'Senior Engineer', '+353 1 476 0321', 'conorfarrel@amics.ie') ON CONFLICT (id) DO NOTHING;

INSERT INTO users (username, password, enabled, authority, first_name, last_name, department, position, phone, email)
VALUES ('noahoconnor', '$2a$10$H.W3HhF8pd2Y/TLfDM.t2uQ0F3yI9el9F8nio6VUijbq.SAg/5Ocq', 1, 'ROLE_USER',
'Noah', 'O’Connor', 'Plant Engineering', 'Engineer', '+353 1 668 7571', 'noahoconnor@amics.ie') ON CONFLICT (id) DO NOTHING;

INSERT INTO users (username, password, enabled, authority, first_name, last_name, department, position, phone, email)
VALUES ('finnmartin', '$2a$10$H.W3HhF8pd2Y/TLfDM.t2uQ0F3yI9el9F8nio6VUijbq.SAg/5Ocq', 1, 'ROLE_USER',
'Finn', 'Martin', 'Plant Engineering', 'Engineer', '+353 1 429 0892', 'finnmartin@amics.ie') ON CONFLICT (id) DO NOTHING;

INSERT INTO users (username, password, enabled, authority, first_name, last_name, department, position, phone, email)
VALUES ('hannahcampbell', '$2a$10$H.W3HhF8pd2Y/TLfDM.t2uQ0F3yI9el9F8nio6VUijbq.SAg/5Ocq', 1, 'ROLE_USER',
'Hannah', 'Campbell', 'Plant Engineering', 'Specialist', '+353 1 072 5491', 'hannahcampbell@amics.ie') ON CONFLICT (id) DO NOTHING;

INSERT INTO users (username, password, enabled, authority, first_name, last_name, department, position, phone, email)
VALUES ('alexodonnell', '$2a$10$H.W3HhF8pd2Y/TLfDM.t2uQ0F3yI9el9F8nio6VUijbq.SAg/5Ocq', 1, 'ROLE_USER',
'Alex', 'O’Donnell', 'Industrial Safety', 'Senior Engineer', '+353 1 198 0935', 'alexodonnell@amics.ie') ON CONFLICT (id) DO NOTHING;

INSERT INTO users (username, password, enabled, authority, first_name, last_name, department, position, phone, email)
VALUES ('ryanoneill', '$2a$10$H.W3HhF8pd2Y/TLfDM.t2uQ0F3yI9el9F8nio6VUijbq.SAg/5Ocq', 1, 'ROLE_USER',
'Ryan', 'O’Neill', 'Industrial Safety', 'Engineer', '+353 1 245 0966', 'ryanoneill@amics.ie') ON CONFLICT (id) DO NOTHING;

INSERT INTO users (username, password, enabled, authority, first_name, last_name, department, position, phone, email)
VALUES ('gaelmccarthy', '$2a$10$H.W3HhF8pd2Y/TLfDM.t2uQ0F3yI9el9F8nio6VUijbq.SAg/5Ocq', 1, 'ROLE_USER',
'Gael', 'McCarthy', 'Maintenance', 'Coordinator', '+353 1 715 0429', 'gaelmccarthy@amics.ie') ON CONFLICT (id) DO NOTHING;

INSERT INTO users (username, password, enabled, authority, first_name, last_name, department, position, phone, email)
VALUES ('roryhayes', '$2a$10$H.W3HhF8pd2Y/TLfDM.t2uQ0F3yI9el9F8nio6VUijbq.SAg/5Ocq', 1, 'ROLE_USER',
'Rory', 'Hayes', 'Maintenance', 'Senior Engineer', '+353 1 663 0713', 'roryhayes@amics.ie') ON CONFLICT (id) DO NOTHING;

INSERT INTO users (username, password, enabled, authority, first_name, last_name, department, position, phone, email)
VALUES ('lorcanfitzgerald', '$2a$10$H.W3HhF8pd2Y/TLfDM.t2uQ0F3yI9el9F8nio6VUijbq.SAg/5Ocq', 1, 'ROLE_USER',
'Lorcan', 'Fitzgerald', 'Maintenance', 'Engineer', '+353 1 769 2098', 'lorcanfitzgerald@amics.ie') ON CONFLICT (id) DO NOTHING;

INSERT INTO users (username, password, enabled, authority, first_name, last_name, department, position, phone, email)
VALUES ('quilloreilly', '$2a$10$H.W3HhF8pd2Y/TLfDM.t2uQ0F3yI9el9F8nio6VUijbq.SAg/5Ocq', 1, 'ROLE_USER',
'Quill', 'O’Reilly', 'Maintenance', 'Engineer', '+353 1 822 0141', 'quilloreilly@amics.ie') ON CONFLICT (id) DO NOTHING;

INSERT INTO users (username, password, enabled, authority, first_name, last_name, department, position, phone, email)
VALUES ('chloeclarke', '$2a$10$H.W3HhF8pd2Y/TLfDM.t2uQ0F3yI9el9F8nio6VUijbq.SAg/5Ocq', 1, 'ROLE_USER',
'Chloe', 'Clarke', 'Maintenance', 'Specialist', '+353 1 159 0386', 'chloeclarke@amics.ie') ON CONFLICT (id) DO NOTHING;

INSERT INTO users (username, password, enabled, authority, first_name, last_name, department, position, phone, email)
VALUES ('briendoyle', '$2a$10$H.W3HhF8pd2Y/TLfDM.t2uQ0F3yI9el9F8nio6VUijbq.SAg/5Ocq', 1, 'ROLE_USER',
'Brien', 'Doyle', 'Production Management', 'Coordinator', '+353 1 031 0922', 'briendoyle@amics.ie') ON CONFLICT (id) DO NOTHING;

INSERT INTO users (username, password, enabled, authority, first_name, last_name, department, position, phone, email)
VALUES ('torinkennedy', '$2a$10$H.W3HhF8pd2Y/TLfDM.t2uQ0F3yI9el9F8nio6VUijbq.SAg/5Ocq', 1, 'ROLE_USER',
'Torin', 'Kennedy', 'Production Management', 'Senior Engineer', '+353 1 525 0206', 'torinkennedy@amics.ie') ON CONFLICT (id) DO NOTHING;

INSERT INTO users (username, password, enabled, authority, first_name, last_name, department, position, phone, email)
VALUES ('pauricgallagher', '$2a$10$H.W3HhF8pd2Y/TLfDM.t2uQ0F3yI9el9F8nio6VUijbq.SAg/5Ocq', 1, 'ROLE_USER',
'Pauric', 'Gallagher', 'Production Management', 'Engineer', '+353 1 221 5533', 'pauricgallagher@amics.ie') ON CONFLICT (id) DO NOTHING;

INSERT INTO users (username, password, enabled, authority, first_name, last_name, department, position, phone, email)
VALUES ('saeranwilson', '$2a$10$H.W3HhF8pd2Y/TLfDM.t2uQ0F3yI9el9F8nio6VUijbq.SAg/5Ocq', 1, 'ROLE_USER',
'Saeran', 'Wilson', 'Production Management', 'Engineer', '+353 1 381 0905', 'saeranwilson@amics.ie') ON CONFLICT (id) DO NOTHING;

INSERT INTO users (username, password, enabled, authority, first_name, last_name, department, position, phone, email)
VALUES ('kateburke', '$2a$10$H.W3HhF8pd2Y/TLfDM.t2uQ0F3yI9el9F8nio6VUijbq.SAg/5Ocq', 1, 'ROLE_USER',
'Kate', 'Burke', 'Production Management', 'Specialist', '+353 1 306 8741', 'kateburke@amics.ie') ON CONFLICT (id) DO NOTHING;

INSERT INTO users (username, password, enabled, authority, first_name, last_name, department, position, phone, email)
VALUES ('charliejohnston', '$2a$10$H.W3HhF8pd2Y/TLfDM.t2uQ0F3yI9el9F8nio6VUijbq.SAg/5Ocq', 1, 'ROLE_USER',
'Charlie', 'Johnston', 'Quality Control', 'Coordinator', '+353 1 190 1422', 'charliejohnston@amics.ie') ON CONFLICT (id) DO NOTHING;

INSERT INTO users (username, password, enabled, authority, first_name, last_name, department, position, phone, email)
VALUES ('liambrown', '$2a$10$H.W3HhF8pd2Y/TLfDM.t2uQ0F3yI9el9F8nio6VUijbq.SAg/5Ocq', 1, 'ROLE_USER',
'Liam', 'Brown', 'Quality Control', 'Senior Engineer', '+353 1 007 2035', 'liambrown@amics.ie') ON CONFLICT (id) DO NOTHING;

INSERT INTO users (username, password, enabled, authority, first_name, last_name, department, position, phone, email)
VALUES ('adamflynn', '$2a$10$H.W3HhF8pd2Y/TLfDM.t2uQ0F3yI9el9F8nio6VUijbq.SAg/5Ocq', 1, 'ROLE_USER',
'Adam', 'Flynn', 'Quality Control', 'Engineer', '+353 1 013 0906', 'adamflynn@amics.ie') ON CONFLICT (id) DO NOTHING;

INSERT INTO users (username, password, enabled, authority, first_name, last_name, department, position, phone, email)
VALUES ('lukehealy', '$2a$10$H.W3HhF8pd2Y/TLfDM.t2uQ0F3yI9el9F8nio6VUijbq.SAg/5Ocq', 1, 'ROLE_USER',
'Luke', 'Healy', 'Quality Control', 'Engineer', '+353 1 715 2237', 'lukehealy@amics.ie') ON CONFLICT (id) DO NOTHING;

INSERT INTO users (username, password, enabled, authority, first_name, last_name, department, position, phone, email)
VALUES ('haileyregan', '$2a$10$H.W3HhF8pd2Y/TLfDM.t2uQ0F3yI9el9F8nio6VUijbq.SAg/5Ocq', 1, 'ROLE_USER',
'Hailey', 'Regan', 'Quality Control', 'Specialist', '+353 1 555 0199', 'haileyregan@amics.ie') ON CONFLICT (id) DO NOTHING;

INSERT INTO inventory_cards (identifier, class, created_at, user_id, product_id, product_name, product_type, product_image,
product_manufacturer, product_country, product_length, product_width, product_height, product_weight, product_description)
VALUES ('67h95110e543', 'Heating', '2022-01-20T20:00:31.650521+03:00', 4,
...
INSERT INTO inventory_cards (identifier, class, created_at, user_id, product_id, product_name, product_type, product_image,
product_manufacturer, product_country, product_length, product_width, product_height, product_weight, product_description)
VALUES ('39h43745e361', 'Electrical', '2022-05-15T15:36:05.436774+03', 12,
...
INSERT INTO inventory_cards (identifier, class, created_at, user_id, product_id, product_name, product_type, product_image,
product_manufacturer, product_country, product_length, product_width, product_height, product_weight, product_description)
VALUES ('09h70728e593', 'Electronics', '2022-11-04T15:49:22.565189+03', 22,
...
INSERT INTO inventory_cards (identifier, class, created_at, user_id, product_id, product_name, product_type, product_image,
product_manufacturer, product_country, product_length, product_width, product_height, product_weight, product_description)
VALUES ('29h64868e615', 'Electronics', '2022-08-12T15:54:56.528053+03', 13,
...
INSERT INTO inventory_cards (identifier, class, created_at, user_id, product_id, product_name, product_type, product_image,
product_manufacturer, product_country, product_length, product_width, product_height, product_weight, product_description)
VALUES ('76h83496e201', 'Electrical', '2022-07-18T10:03:22.43271+03', 5,
...
INSERT INTO inventory_cards (identifier, class, created_at, user_id, product_id, product_name, product_type, product_image,
product_manufacturer, product_country, product_length, product_width, product_height, product_weight, product_description)
VALUES ('44h88767e534', 'Electrical', '2022-04-03T11:21:32.71199+03', 5,
...
INSERT INTO inventory_cards (identifier, class, created_at, user_id, product_id, product_name, product_type, product_image,
product_manufacturer, product_country, product_length, product_width, product_height, product_weight, product_description)
VALUES ('58h23915e201', 'Electrical', '2022-02-07T15:28:47.305944+03', 17,
...
INSERT INTO inventory_cards (identifier, class, created_at, user_id, product_id, product_name, product_type, product_image,
product_manufacturer, product_country, product_length, product_width, product_height, product_weight, product_description)
VALUES ('30h52569e428', 'Electrical', '2022-02-20T13:34:50.787951+03', 13,
...
INSERT INTO inventory_cards (identifier, class, created_at, user_id, product_id, product_name, product_type, product_image,
product_manufacturer, product_country, product_length, product_width, product_height, product_weight, product_description)
VALUES ('82h16047e756', 'Electrical', '2022-03-12T14:40:20.684137+03', 8,
...
INSERT INTO inventory_cards (identifier, class, created_at, user_id, product_id, product_name, product_type, product_image,
product_manufacturer, product_country, product_length, product_width, product_height, product_weight, product_description)
VALUES ('10h75036e635', 'Ventilation', '2022-09-12T10:50:45.810303+03', 6,
...
INSERT INTO inventory_cards (identifier, class, created_at, user_id, product_id, product_name, product_type, product_image,
product_manufacturer, product_country, product_length, product_width, product_height, product_weight, product_description)
VALUES ('99h47459e398', 'Ventilation', '2022-06-23T16:08:59.493474+03', 6,
...
INSERT INTO inventory_cards (identifier, class, created_at, user_id, product_id, product_name, product_type, product_image,
product_manufacturer, product_country, product_length, product_width, product_height, product_weight, product_description)
VALUES ('66h12772e021', 'Air conditioning', '2022-07-05T15:41:10.312948+03', 21,
...
INSERT INTO inventory_cards (identifier, class, created_at, user_id, product_id, product_name, product_type, product_image,
product_manufacturer, product_country, product_length, product_width, product_height, product_weight, product_description)
VALUES ('04h84995e175', 'Heating', '2022-05-22T11:20:17.336819+03', 16,
...
INSERT INTO inventory_cards (identifier, class, created_at, user_id, product_id, product_name, product_type, product_image,
product_manufacturer, product_country, product_length, product_width, product_height, product_weight, product_description)
VALUES ('56h35862e359', 'Mechanical', '2022-01-27T12:39:47.179479+03', 6,
...
INSERT INTO inventory_cards (identifier, class, created_at, user_id, product_id, product_name, product_type, product_image,
product_manufacturer, product_country, product_length, product_width, product_height, product_weight, product_description)
VALUES ('11h41221e688', 'Mechanical', '2022-02-02T12:56:07.271534+03', 6,
...
INSERT INTO inventory_cards (identifier, class, created_at, user_id, product_id, product_name, product_type, product_image,
product_manufacturer, product_country, product_length, product_width, product_height, product_weight, product_description)
VALUES ('91h40514e543', 'Mechanical', '2022-11-13T14:46:16.848784+03', 11,
...
INSERT INTO inventory_cards (identifier, class, created_at, user_id, product_id, product_name, product_type, product_image,
product_manufacturer, product_country, product_length, product_width, product_height, product_weight, product_description)
VALUES ('48h65573e356', 'Hydraulics', '2022-12-29T13:18:59.130218+03', 6,
...
INSERT INTO inventory_cards (identifier, class, created_at, user_id, product_id, product_name, product_type, product_image,
product_manufacturer, product_country, product_length, product_width, product_height, product_weight, product_description)
VALUES ('56h10157e430', 'Gas', '2022-05-26T15:25:36.882354+03', 7,
...
INSERT INTO inventory_cards (identifier, class, created_at, user_id, product_id, product_name, product_type, product_image,
product_manufacturer, product_country, product_length, product_width, product_height, product_weight, product_description)
VALUES ('83h39851e755', 'Gas', '2022-04-21T16:37:59.411068+03', 9,
...
INSERT INTO inventory_cards (identifier, class, created_at, user_id, product_id, product_name, product_type, product_image,
product_manufacturer, product_country, product_length, product_width, product_height, product_weight, product_description)
VALUES ('88h27958e046', 'Gas', '2022-09-11T13:40:35.275607+03', 7,
